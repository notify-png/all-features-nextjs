...
export default async function LocaleSlugPage(
  ...
  // Gallery shows still-frame previews (per-slug override → Pexels → Picsum → LoremFlickr).
          ...
          <section className="section">
            ...
            <div className="gallery-grid">
              <div className="gallery-item rv rv-1" style={{ gridRow: 'span 2' }}>
                ...
                <img
                  src={img1}
                  alt={`Single frame from an AI-generated ${genre} music video — ${vk[0] || genre} aesthetic`}
                  loading="lazy"
                  width={600}
                  height={420}
                />
              ...
              <div className="gallery-item rv rv-2">
                ...
                <img
                  src={img2}
                  alt={`Frame preview of an AI ${genre} music video — ${vk[1] || vk[0] || genre}`}
                  loading="lazy"
                  width={400}
                  height={220}
                />
              ...
              <div className="gallery-item rv rv-3">
                ...
                <img
                  src={img3}
                  alt={`AI ${genre} music video frame — ${mw[0] || 'cinematic'} mood`}
                  loading="lazy"
                  width={400}
                  height={220}
                />
