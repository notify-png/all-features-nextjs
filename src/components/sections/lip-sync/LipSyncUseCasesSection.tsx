...
import { Mic, Smartphone, Gamepad2, Megaphone } from "lucide-react";
import { useTranslations } from "next-intl";

const LipSyncUseCasesSection = () => {
  const t = useTranslations("LipSync");
  const useCases = [
    { icon: Mic, title: t("use1Title"), description: t("use1Desc") },
    { icon: Smartphone, title: t("use2Title"), description: t("use2Desc") },
...
export default LipSyncUseCasesSection;
