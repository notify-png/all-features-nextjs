...
const AiSingerComparisonSection = () => {
    ...
    <section className="section-padding bg-background">
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <h3 className="card-title text-foreground mb-6">
              {t("compareTradTitle")}
            </h3>
            ...
            <ul className="space-y-4">
              {aiItems.map((item, index) => (
                ...
                >
                  ...
                  <span className="text-foreground font-poppins">{item}</span>
                </motion.li>
              ))}
            </ul>
          </motion.div>
...
export default AiSingerComparisonSection;
