...
import { Target, Sliders, Video, Zap } from "lucide-react";
import { useTranslations } from "next-intl";

const MotionControlWhyChooseSection = () => {
  const t = useTranslations("MotionControl");
  const features = [
    { icon: Target, title: t("why1Title"), description: t("why1Desc") },
    { icon: Sliders, title: t("why2Title"), description: t("why2Desc") },
    { icon: Video, title: t("why3Title"), description: t("why3Desc") },
...
export default MotionControlWhyChooseSection;
