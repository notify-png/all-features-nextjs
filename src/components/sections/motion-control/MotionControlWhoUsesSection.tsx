...
const MotionControlWhoUsesSection = () => {
  const [activeTab, setActiveTab] = useState("filmmakers");
  const t = useTranslations("MotionControl");

  const tabs = [
    { id: "filmmakers", label: t("whoTab1"), title: t("who1Title"), description: t("who1Desc") },
    { id: "creators", label: t("whoTab2"), title: t("who2Title"), description: t("who2Desc") },
    { id: "studios", label: t("whoTab3"), title: t("who3Title"), description: t("who3Desc") },
    { id: "marketers", label: t("whoTab4"), title: t("who4Title"), description: t("who4Desc") },
  ];
...
export default MotionControlWhoUsesSection;
