...
const AiDancingWhyChooseSection = () => {
  const t = useTranslations("AiDancing");
  const features = [
    { icon: Zap, title: t("why1Title"), description: t("why1Desc") },
    { icon: Sparkles, title: t("why2Title"), description: t("why2Desc") },
    { icon: Shield, title: t("why3Title"), description: t("why3Desc") },
  ];
...
export default AiDancingWhyChooseSection;
