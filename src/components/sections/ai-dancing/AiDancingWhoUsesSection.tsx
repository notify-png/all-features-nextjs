...
const AiDancingWhoUsesSection = () => {
  const [activeTab, setActiveTab] = useState("influencers");
  const t = useTranslations("AiDancing");

  const tabs = [
    { id: "influencers", label: t("whoTab1"), title: t("who1Title"), description: t("who1Desc") },
    { id: "marketers", label: t("whoTab2"), title: t("who2Title"), description: t("who2Desc") },
    { id: "entertainers", label: t("whoTab3"), title: t("who3Title"), description: t("who3Desc") },
    { id: "developers", label: t("whoTab4"), title: t("who4Title"), description: t("who4Desc") },
  ];
...
export default AiDancingWhoUsesSection;
