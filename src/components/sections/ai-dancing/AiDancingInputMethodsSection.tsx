...
const AiDancingInputMethodsSection = () => {
  const t = useTranslations("AiDancing");
  const methods = [
    { icon: Image, title: t("input1Title"), description: t("input1Desc") },
    { icon: Music, title: t("input2Title"), description: t("input2Desc") },
    { icon: Video, title: t("input3Title"), description: t("input3Desc") },
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {methods.map((method, index) => (
            <motion.div
              ...
              className="group relative p-6 rounded-2xl bg-card border border-border hover:border-foreground/20 hover:shadow-xl transition-all duration-500 cursor-pointer"
            >
              <div className="mb-5">
                <motion.div
...
export default AiDancingInputMethodsSection;
