...
export const T: Record<string, UIStrings> = {
  en: {
    ...
    galleryH2: (genre) => `Frame previews from AI ${genre} music videos`,
    gallerySub: (genre) => `Single frames pulled from AI-generated music videos — a glimpse of the ${genre} visual style Tunee creates from your audio, no camera or crew needed.`,
  ...
  es: {
    ...
    galleryH2: (genre) => `Vistas previas de fotogramas de videoclips IA de ${genre}`,
    gallerySub: (genre) => `Fotogramas individuales extraídos de videoclips generados con IA — un vistazo al estilo visual de ${genre} que Tunee crea desde tu audio, sin cámara ni equipo.`,
  ...
  ja: {
    ...
    galleryH2: (genre) => `AI で生成された${genre}ミュージックビデオのフレームプレビュー`,
    gallerySub: (genre) => `AI 生成のミュージックビデオから抜き出した個々のフレーム — Tunee があなたの音源から作る${genre}のビジュアルスタイルを垣間見る、カメラもクルーも不要。`,
  ...
  ko: {
    ...
    galleryH2: (genre) => `AI ${genre} 뮤직비디오의 프레임 미리보기`,
    gallerySub: (genre) => `AI로 생성된 뮤직비디오에서 뽑은 개별 프레임 — Tunee가 당신의 오디오에서 만드는 ${genre} 비주얼 스타일을 엿보세요. 카메라나 촬영팀 불필요.`,
  ...
  ru: {
    ...
    galleryH2: (genre) => `Кадры из AI клипов ${genre}`,
    gallerySub: (genre) => `Отдельные кадры из клипов, созданных ИИ — взгляд на визуальный стиль ${genre}, который Tunee создаёт из вашего звука. Камера и команда не нужны.`,
  ...
  fr: {
    ...
    galleryH2: (genre) => `Aperçus d'images de clips IA ${genre}`,
    gallerySub: (genre) => `Images individuelles extraites de clips générés par IA — un aperçu du style visuel ${genre} que Tunee crée depuis votre audio, sans caméra ni équipe.`,
  ...
  de: {
    ...
    galleryH2: (genre) => `Frame-Vorschauen aus KI-${genre}-Musikvideos`,
    gallerySub: (genre) => `Einzelne Frames aus KI-generierten Musikvideos — ein Blick auf den ${genre}-Visualstil, den Tunee aus deinem Audio erstellt. Keine Kamera, keine Crew.`,
  ...
  pt: {
    ...
    galleryH2: (genre) => `Prévias de quadros de videoclipes IA de ${genre}`,
    gallerySub: (genre) => `Quadros individuais extraídos de videoclipes gerados com IA — uma amostra do estilo visual ${genre} que o Tunee cria do seu áudio, sem câmera ou equipe.`,
  ...
  it: {
    ...
    galleryH2: (genre) => `Anteprime di fotogrammi da video musicali AI di ${genre}`,
    gallerySub: (genre) => `Singoli fotogrammi estratti da video musicali generati con AI — uno sguardo allo stile visivo ${genre} che Tunee crea dal tuo audio, senza telecamera o crew.`,
  ...
  'zh-HK': {
    ...
    heroEyebrow: 'AI 音樂視頻',
    galleryEyebrow: '視覺範例',
    galleryH2: (genre) => `AI ${genre} 音樂影片畫面預覽`,
    gallerySub: (genre) => `從 AI 生成的音樂影片中抽出的單張畫面 — 一窺 Tunee 從你的音頻生成的 ${genre} 視覺風格，無需攝影機或拍攝團隊。`,
  ...
  'zh-CN': {
    ...
    heroEyebrow: 'AI 音乐视频',
    galleryEyebrow: '视觉示例',
    galleryH2: (genre) => `AI ${genre} 音乐视频画面预览`,
    gallerySub: (genre) => `从 AI 生成的音乐视频中抽出的单张画面 — 一窥 Tunee 从你的音频生成的 ${genre} 视觉风格，无需摄影机或拍摄团队。`,
